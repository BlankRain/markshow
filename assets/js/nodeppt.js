(function ($win, $doc, $B, loadJS, loadCSS, undefined) {
    ...
    try {
        if (window.console && window.console.log) {
            console.log('Based On nodePPT, %c https://github.com/ksky521/nodePPT', 'color:green');
            console.log('Install nodePPT: %c npm install -g nodeppt', 'color:green');
            console.log('Re Powered By markshow, %c https://github.com/BlankRain/markshow', 'color:green');
        }
    } catch (e) {}
